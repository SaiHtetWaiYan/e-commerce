...
<head>
    ...
    <title>Sign in - {{ config('app.name', 'Marketplace') }}</title>
    ...
    <div class="min-h-full flex flex-col items-center justify-center px-4 py-12 relative z-10">
        ...
        <div class="w-full max-w-[420px] bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-8 pb-0 text-center">
                <h2 class="text-2xl font-black text-gray-900 dark:text-white mb-2">Welcome back</h2>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Sign in to continue shopping</p>
            </div>
            ...
            <div class="p-8">
                ...
                <div class="relative mb-6">
                    ...
                    <div class="relative flex justify-center text-sm"><span class="bg-white dark:bg-gray-800 px-3 text-gray-500 dark:text-gray-400 font-medium">Or continue with email</span></div>
                </div>
                ...
                <form action="{{ route('login.attempt') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="password" name="password" type="password" autocomplete="current-password" required class="block w-full border border-gray-300 dark:border-gray-600 rounded-xl py-2.5 px-4 text-gray-900 dark:text-white bg-white dark:bg-gray-900 focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all" placeholder="Enter your password">
                    </div>

                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input id="remember" name="remember" type="checkbox" value="1" class="h-4 w-4 rounded border-gray-300 dark:border-gray-600 text-primary-600 focus:ring-primary-500 bg-white dark:bg-gray-900">
                            <label for="remember" class="ml-2 text-sm font-medium text-gray-600 dark:text-gray-400">Remember me</label>
                        </div>
                        <a href="{{ route('password.request') }}" class="text-sm font-bold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">Forgot password?</a>
                    </div>
                ...
                <div class="mt-6 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 text-sm text-gray-500 dark:text-gray-400 flex items-center gap-3">
                    ...
                    <div>
                        <span class="font-bold text-gray-700 dark:text-gray-300">Demo Access:</span>
                        Try <code class="bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-1 rounded">admin@marketplace.test</code> / <code class="bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 px-1 rounded">password</code>
                    </div>
                </div>

                <p class="mt-6 text-center text-sm font-medium text-gray-600 dark:text-gray-400">
                    New to {{ config('app.name') }}? <a href="{{ route('register') }}" class="font-bold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">Create an account</a>
                </p>
